...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Keep loading until redirect or error
    }
  };

  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-slate-50/10 selection:bg-blue-500/30">
      ...
      >
        <div className="bg-white/95 backdrop-blur-2xl rounded-[3rem] p-12 md:p-16 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-blue-500/5 relative overflow-hidden box-border">
          ...
          <div className="w-full space-y-10 relative z-10">
              ...
              <div className="space-y-4">
                <button
                  ...
                  disabled={isLoading}
                  className="w-full h-16 bg-[#0a0c10] rounded-3xl flex items-center justify-center gap-4 hover:bg-[#1a1c22] active:scale-[0.98] transition-all duration-300 shadow-[0_10px_30px_-5px_rgba(0,0,0,0.15)] group relative overflow-hidden"
                >
                   {isLoading ? (
                     ...
                     <>
                        ...
                        <span className="font-extrabold text-white uppercase tracking-[0.15em] text-[11px]">
                          Login with Google
                        </span>
                     </>
                   )}
